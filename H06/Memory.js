...
function createMonkeyArray() {
    ...
    while (mijnpokemon.length <= 17) {
        pokemonnummer = Math.floor((Math.random() *9)+1);
        if (occurencesInArray(mijnpokemon, pokemonnummer,2)) {
            mijnpokemon.push(pokemonnummer);
        }
    }
    return mijnpokemon;
}
